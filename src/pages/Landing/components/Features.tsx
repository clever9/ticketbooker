  ...
  return (
    <>
      <div className="bg-white" style={{ padding: "9% 15px" }}>
        <h1 className="text-center xl:text-4xl text-2xl font-bold text-purple-700">
          What we promise?
        </h1>
        <div className="flex flex-wrap gap-y-5 py-10">
          <div className="w-full lg:w-3/12 md:w-6/12">
            <div className="flex flex-col justify-center items-center bg-purple-50 p-10 rounded-md outline-none outline-offset-0 mx-2">
              ...
              <p className="font-bold text-gray-700 mt-4">Fast Process</p>
              <p className="font-light text-gray-700 mt-2 text-center">
          ...
          <div className="w-full lg:w-3/12 md:w-6/12">
            <div className="flex flex-col justify-center items-center bg-purple-50 p-10 rounded-md outline-none outline-offset-0 mx-2">
              ...
              <p className="font-bold text-gray-700 mt-4">Secure Payment</p>
              <p className="font-light text-gray-700 mt-2 text-center">
                Lorem ipsum dolor sit amet consectetur.
              </p>
            </div>
          ...
          <div className="w-full lg:w-3/12 md:w-6/12">
            <div className="flex flex-col justify-center items-center bg-purple-50 p-10 rounded-md outline-none outline-offset-0 mx-2">
              ...
              <p className="font-bold text-gray-700 mt-4">Concise Steps</p>
              <p className="font-light text-gray-700 mt-2 text-center">
                Lorem ipsum dolor sit amet consectetur.
              </p>
            </div>
          ...
          <div className="w-full lg:w-3/12 md:w-6/12">
            <div className="flex flex-col justify-center items-center bg-purple-50 p-10 rounded-md outline-none outline-offset-0 mx-2">
              ...
              <p className="font-bold text-gray-700 mt-4">All in one</p>
              <p className="font-light text-gray-700 mt-2 text-center">
                Lorem ipsum dolor sit amet consectetur.
              </p>
            </div>
