      ...
      <div className="bg-gray-800">
        ...
        <div className="flex flex-col items-center min-w-screen py-14 px-6 text-white font-bold text-5xl">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#"
              className="rounded-lg bg-purple-600 px-3.5 py-2.5 text-lg text-white font-semibold text-gray-900 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Get started
            </a>
